...
class HeadEditTable extends Page {
	...
	public final JL hea = new JL(MainLocale.INFO, "ht00");
	public final JL len = new JL(MainLocale.INFO, "ht01");
	public final JBTN mus = new JBTN(MainLocale.INFO, "mus");
	public final JL max = new JL(MainLocale.INFO, "ht02");
	public final JBTN bg = new JBTN(MainLocale.INFO, "ht04");
	public final JBTN cas = new JBTN(MainLocale.INFO, "ht05");
	public final JTF name = new JTF();
	public final JTF jhea = new JTF();
	public final JTF jlen = new JTF();
	public final JTF jbg = new JTF();
	public final JTF jcas = new JTF();
	public final JTF jm0 = new JTF();
	public final JTF jmh = new JTF();
	public final JTF jm1 = new JTF();
	public final JTF jbgh = new JTF();
	public final JTF jbg1 = new JTF();
	public final JTG con = new JTG(MainLocale.INFO, "ht03");
	public final JTF[] star = new JTF[4];
	public final JTF jmax = new JTF();
	public final JL res = new JL(MainLocale.INFO, "minspawn");
	public final JL cost = new JL(MainLocale.INFO, "chcos");
	public final JTF jres = new JTF();
	public final JTF cos = new JTF();
	public final JTG dojo = new JTG(MainLocale.PAGE,"dojo");
